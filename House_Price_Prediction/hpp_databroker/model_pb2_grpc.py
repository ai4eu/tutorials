...
class DatabrokerStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.hppdatabroker = channel.unary_unary(
                '/Databroker/hppdatabroker',
...
def add_DatabrokerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'hppdatabroker': grpc.unary_unary_rpc_method_handler(
                    servicer.hppdatabroker,
...
class Databroker(object):
    ...
    def hppdatabroker(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Databroker/hppdatabroker',
