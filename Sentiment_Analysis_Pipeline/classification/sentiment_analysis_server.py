...
class sentiment_analysis_modelServicer(prediction_model_pb2_grpc.sentiment_analysis_modelServicer):
    def classify_review(self, request, context):
        # define the buffer of the response :
        response = prediction_model_pb2.Review_Classify()
...
prediction_model_pb2_grpc.add_sentiment_analysis_modelServicer_to_server(sentiment_analysis_modelServicer(), server)
